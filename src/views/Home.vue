<template>
  <div id="Home">
    <div class="locationsList">
      ...
      <div class="places">
          <div class="place" v-for='place in fromMap' :key='place.id' :ref='place.id'>
            <div>
              <h3>{{ place.name }}</h3>
              <p>{{ place.vicinity }}</p>
            </div>
            <div class="fav" @click.prevent='$set(place, "saved", !place.saved); saveFav(place.name, place.id);'>
              <a :class="{saved: place.saved}" href="#">
